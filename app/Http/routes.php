...
//basic routes
Route::group(['before' => 'oauth:basic', 'prefix' => 'v'.env('APP_API_VERSION'), 'namespace' => 'Basic'], function() {
...
Route::group(['before' => 'oauth:admin', 'prefix' => 'admin', 'namespace' => 'Admin'], function(){
    ...
    Route::resource('images','ComicImagesController', array('only' => array('index', 'show', 'update')));
