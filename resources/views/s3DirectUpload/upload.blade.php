...
// Fill These In!
define('S3_BUCKET', env('AWS_S3_Uploads'));
define('S3_KEY',   env('AWS_ACCESS_KEY_ID'));
define('S3_SECRET', env('AWS_SECRET_ACCESS_KEY'));
define('S3_REGION', 'us-east-1');        // S3 region name: http://amzn.to/1FtPG6r
...
$policy = [
    ...
    'conditions' => [
        ...
        ['x-amz-date' => $date],
        ['starts-with', '$x-amz-meta-series-id', '']
    ]
];
...
<html>
    ...
    <body>
        ...
        <form action="//<?php echo S3_BUCKET . "." . $service; ?>.amazonaws.com"
            ...
            <input type="hidden" name="x-amz-meta-series-id" value="RANDOM_UUID">
        ...
        <script src="//rawgit.com/eddturtle/direct-upload-s3-signaturev4/master/fileupload/jquery.fileupload.js"></script>
        <script>
